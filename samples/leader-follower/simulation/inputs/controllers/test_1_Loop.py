...
class TestLoop:
    ...
    def __init__(self, H,V,uav_prefix,yaw, _distThreshold):
	self.distThreshold = _distThreshold;
...
if __name__ == "__main__":
    TestLoop(float(sys.argv[1]), float(sys.argv[2]), sys.argv[3], float(sys.argv[4]), float(sys.argv[5]))
